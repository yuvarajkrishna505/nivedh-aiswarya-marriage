...
export default function Venue() {
  return (
    <section id="venue" className="py-16 md:py-24 bg-charcoal text-cream relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.div
           ...
           className="border border-gold p-6 md:p-16 relative bg-charcoal shadow-[0_0_30px_rgba(212,175,55,0.05)]"
        >
          {/* Decorative Corners */}
